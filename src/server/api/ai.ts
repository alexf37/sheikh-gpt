...
const rulingSchema = z.object({
  ...
  references: z.array(z.string().max(1000)).optional(),
});
      ...
      messages: [
        {
          ...
          content: `You are a knowledgeable Islamic scholar who can determine whether something is halal (permissible) or haram (forbidden) in Islam.
              ...
              - references: string[] (array of relevant references from Islamic sources), though this is optional (it can be undefined). Keep these brief, no more than 3 citations with each one at most 100 characters. It helps to quote the Quran when possible, rather than just citing the page.
